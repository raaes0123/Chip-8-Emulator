...
INCLUDE_PATHS = -I include -I. -I$(RAYLIB_PATH)/src -I$(RAYLIB_PATH)/src/external
...
$(PROJECT_NAME): $(OBJ)
	$(CC) -o $(PROJECT_NAME)$(EXT) $(OBJ) $(CFLAGS) $(INCLUDE_PATHS) $(LDFLAGS) $(LDLIBS) -D$(PLATFORM)
